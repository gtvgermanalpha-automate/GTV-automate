"""One-off: migrate the GTV semi sheet's products into the Full-auto
sheet (2026-08-12, same proven pattern as Arden's two-phase migration).
For every semi row whose SKU has a LIVE listing on the GTV OnBuy account, append a Full-sheet row carrying SKU + Supplier URL +
