...
def main():
    ...
    # doesn't know and defers "Awaiting OnBuy go-live" forever (the 127
    # census-pair products, repaired 2026-08-25, all carry leading-zero
    # SKUs). Formatting characters are stripped; leading zeros are kept.
